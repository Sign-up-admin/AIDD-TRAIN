...
class ValidationError(ServiceException):
    ...
    def __init__(self, message: str, error_code: ErrorCode = ErrorCode.VALIDATION_ERROR, detail: Optional[Dict] = None):
        super().__init__(
            message=message,
...
class NotFoundError(ServiceException):
    ...
    def __init__(self, resource_type: str, resource_id: str, error_code: ErrorCode = ErrorCode.RESOURCE_NOT_FOUND):
...
class ConflictError(ServiceException):
    ...
    def __init__(self, message: str, error_code: ErrorCode = ErrorCode.RESOURCE_CONFLICT, detail: Optional[Dict] = None):
        super().__init__(
            message=message,
            error_code=error_code,
            detail=detail
