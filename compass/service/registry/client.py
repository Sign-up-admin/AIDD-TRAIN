...
class CompassRegistryClient:
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                if attempt < max_retries:
                    ...
                    logger.error(f"Failed to register service after {max_retries + 1} attempts: {e}")
        
        # All retries failed
        raise Exception(f"Failed to register service after {max_retries + 1} attempts") from last_exception
    ...
    def start_heartbeat(self):
        ...
        self.heartbeat_thread = threading.Thread(target=heartbeat_loop, daemon=True, name="HeartbeatThread")
