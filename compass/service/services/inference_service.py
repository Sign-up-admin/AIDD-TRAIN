...
class InferenceService:
    ...
    def __init__(self, model_service: ModelService):
        ...
        logger.info(
            f"Inference service initialized with device: {self.device}, cache size: {max_cache_size}"
        )
    ...
    def predict(self, request: InferenceRequest) -> InferenceResponse:
        ...
        try:
            ...
            return InferenceResponse(
                binding_affinity=binding_affinity, model_id=model_id, inference_time=inference_time
            )
    ...
    def batch_predict(self, requests: List[InferenceRequest]) -> BatchInferenceResponse:
        ...
        logger.info(
            f"Batch prediction completed: {success_count} succeeded, {failed_count} failed out of {len(requests)}"
        )
